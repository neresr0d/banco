<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/estante_web/bancoviews/__cabecalho.php';
...
<main id="conteudo-categoria">
  <div id="modal-categorias">
    ...
    <form action="/estante_web/banco/controllers/edit_categoria_controller.php" method="post" id="form-editCategoria    ">
