...
<body>
    ...
    <nav>
       ...
       <?php if(Auth::estarLogado()):?>
        ...
        <a href="/estante_web/banco/views/login.php" class="alinhar"><img src="/estante_web/banco/imgs/user-solid.svg" alt="" height="30px" width="30px">Olá, <span><?=$_SESSION['nome_usuario'];?></span></a>  <a href="/estante_web/banco/controllers/logout_controller.php"><button class="bot-sair">Sair</button> </a>
        <?php else : ?>
