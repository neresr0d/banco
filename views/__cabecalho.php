...
<body>
    ...
    <nav>
        ...
        <a href="/estante_web/banco/views/login.php" class="alinhar"><img src="/estante_web/banco/imgs/user-solid.svg" alt="" height="30px" width="30px">Olá, usuário<!--<span>?=$_SESSION['nome_usuario']?--></span></a>
        <!--?php else : ?>-->
